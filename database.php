<?php
    ...
    if (!$db_selected) {
        ...
        if (mysqli_query($conn,$sql)) {
            ...
            //sql to create table event
            $event_data = "INSERT INTO `event` (`id`, `name`, `description`, `date`, `time`, `venue`, `user_id`) VALUES
            (1, 'Web Development Workshop', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', '2018-03-10', '20:00:00', 'Classroom', 1),
            (2, 'Career Fair', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', '2018-01-05', '09:00:00', 'Grand Hall', 2),
            (3, 'Japanese Cultural Festival', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', '2018-04-05', '19:00:00', 'National Sports Complex', 3),
            (4, 'Charity Run', 'This is a charity run. ', '2018-01-21', '07:30:00', 'D\'Pulze Cyberjaya', 4),
            (5, 'Fun Fair', 'This is a fun fair.', '2018-01-21', '09:00:00', 'Shaftsbury Square', 4),
            (6, 'BBQ Night', 'This is a bbq night.', '2018-01-31', '19:00:00', 'FCI, Multimedia University Cyberjaya', 4);";
